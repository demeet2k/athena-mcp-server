...
- The live orchestration mirror is pinned to `L01 Prime Lock` complete, `L02 Whole-Corpus Census` active, and governing Temple quest `TQ07`.
- Public quest publication is now mirrored honestly as `8` Hall promotions and `8` Temple promotions per loop.
