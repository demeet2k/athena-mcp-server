...
This wrapper leaves the existing server entrypoint unchanged. Mycelium discovery
resolves this entrypoint when the KC144 tool seed is selected.
"""
...
if mcp is None:
    raise RuntimeError(
        "Could not find a FastMCP-compatible server object in athena_mcp_server"
    )
