...
from .federation_ephemeral_bridge import FederationEphemeralBridgeSurface
from .federation_ephemeral_bridge_protocol import FEDERATION_EPHEMERAL_RESOURCE,FEDERATION_EPHEMERAL_TOOLS
...
AOR_DEVELOPMENT_TOOLS=(
    ...
    list(BIONANOMACHINE_TOOLS)+list(EPHEMERAL_COORDINATION_TOOLS)+list(FEDERATION_EPHEMERAL_TOOLS)
)
AOR_DEVELOPMENT_RESOURCES=(
    ...
    list(BIONANOMACHINE_RESOURCES)+[EPHEMERAL_COORDINATION_RESOURCE,FEDERATION_EPHEMERAL_RESOURCE]
)
...
class AorDevelopmentSurface:
    ...
    Constructor order is intentional:
      ...
      ephemeral request/poll coordination membrane -> typed lossy Federation
      cursor/handoff projection over that existing transport.
    ...
    def __init__(self,server):
        ...
        self.federation_ephemeral_bridge=FederationEphemeralBridgeSurface(self.ephemeral_coordination.runtime)
    ...
    def call_tool(self,name:str,args:Dict[str,Any]):
        ...
        handled,value=self.federation_ephemeral_bridge.call_tool(name,args)
    ...
    def read_resource(self,uri:str):
        if uri==FEDERATION_EPHEMERAL_RESOURCE['uri']:return self.federation_ephemeral_bridge.read_resource(uri)
