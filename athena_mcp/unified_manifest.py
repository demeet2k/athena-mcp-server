...
BRAID_LAW='AOR chooses developmental frontier/WHAT; Collective V1-V12 organizes HOW scarce execution/science/control/inference/adaptation/joint-model capacity is used; Y1 governs canonical claim authority; EQ1 governs witnessed collapse; consensus/pheromone/reward are never typed authority or evidence by themselves; model posterior/replication shadow are also never typed authority or evidence by themselves.'
