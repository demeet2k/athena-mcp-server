...
UNIFIED_MANIFEST_VERSION='ATHENA.RUNTIME.UNIFIED.6'
...
BRAID_LAW='AOR chooses developmental frontier/WHAT; Collective V1-V11 organizes HOW scarce execution/science/control/inference/adaptation capacity is used; Y1 governs canonical claim authority; EQ1 governs witnessed collapse; consensus/pheromone/reward are never typed authority or evidence by themselves; model posterior/replication shadow are also never typed authority or evidence by themselves.'
...
def build_unified_manifest(server)->Dict[str,Any]:
    ...
    return {
        'artifact':UNIFIED_MANIFEST_VERSION,'artifact_compat':['ATHENA.RUNTIME.UNIFIED.1','ATHENA.RUNTIME.UNIFIED.2','ATHENA.RUNTIME.UNIFIED.3','ATHENA.RUNTIME.UNIFIED.4','ATHENA.RUNTIME.UNIFIED.5'],'role':'live machine-readable runtime architecture projection','runtime_class':type(server).__name__,
