...
def handle(server,m):
    ...
    if method=='prompts/get':
        ...
        text='ATHENA UNIFIED AOR×COLLECTIVE V9 MAXDEV\nAGENT='+str(agent)+'\nTASK='+str(task)+'\n'+maxdev_law()
        return server.result(mid,{'description':'Unified AOR/Y1 developmental cortex × Collective V1–V9 organization/science/discovery/belief/inference cycle','messages':[{'role':'user','content':{'type':'text','text':text}}]})
