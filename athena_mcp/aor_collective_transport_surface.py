...
AOR_COLLECTIVE_TRANSPORT_TOOLS=(
    list(TRANSPORT_TOOLS)+list(PARTY_COORDINATION_TOOLS)+list(IMPOSSIBLE_GODBOARD_TOOLS)+list(COHESION_MESH_TOOLS)
)
...
AOR_COLLECTIVE_TRANSPORT_TOOL_NAMES=(
    set(TRANSPORT_TOOL_NAMES)|set(PARTY_COORDINATION_TOOL_NAMES)|set(IMPOSSIBLE_GODBOARD_TOOL_NAMES)|set(COHESION_MESH_TOOL_NAMES)
)
