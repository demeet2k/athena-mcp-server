...
{"name":"athena_gap_get","description":"Fetch one persisted GAPRUN with exact source/edge/target/policy snapshot, closure paths, residuals, grow decision and digest.","inputSchema":{"type":"object","required":["run_id"],"properties":{"run_id":{"type":"string"}},"additionalProperties":False}},
{"name":"athena_gap_replay","description":"Recompile one GAPRUN from frozen inputs and compare closure nodes, gap, grow and decision digest.","inputSchema":{"type":"object","required":["run_id"],"properties":{"run_id":{"type":"string"}},"additionalProperties":False}},
