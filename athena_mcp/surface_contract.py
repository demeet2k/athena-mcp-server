...
REQUIRED_RESOURCES={
 ...
 'collective':{'athena://collective/runtime','athena://collective/growth','athena://collective/v2','athena://collective/v3','athena://collective/v4','athena://collective/v5','athena://collective/v6','athena://collective/v7'},
...
def contract_manifest()->Dict[str,Any]:
    return {
        ...
        'law':'promoted unified runtime must preserve every mature base + Collective V1-V7 + AOR + FIELD/transport/CYCLE + state-foundation + startup/self-test + live-manifest + governance surface unless explicit versioned supersession/migration changes this contract',
    }
