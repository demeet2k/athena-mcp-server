...
def call(robust,name,a):
    ...
    if name=='athena_longitudinal_tmle':return robust.longitudinal_tmle(a['samples'],a['treatment1'],a['intermediate'],a['treatment2'],a['outcome'],a.get('baseline'),a.get('regimes'),a.get('assumptions'),a.get('propensity_clip',.05))
