...
# V15 + V3.4 admission frontier. Automatic tool-crossing sharing remains opt-in.
# V1 identity/scope laws are preserved. V1.1 replaces only the attention
# treatment with a bounded critical reserve and adds a strict machine-readable
# semantic envelope before the extension creates its runtime instance.
