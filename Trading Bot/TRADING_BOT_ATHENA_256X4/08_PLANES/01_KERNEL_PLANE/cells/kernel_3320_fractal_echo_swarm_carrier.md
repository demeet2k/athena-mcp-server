...
- plane: `kernel`
- address: `3320`
- components: `fractal echo` -> `swarm carrier` -> `corridor grammar` -> `state vector`
...
- output atom: `04_SWARM/output_atoms/atom_3320.md`

## 256^4 Expansion Vector

- kernel address: `3320`
- market address: `3203`
- execution address: `0013`
- governance address: `0233`
