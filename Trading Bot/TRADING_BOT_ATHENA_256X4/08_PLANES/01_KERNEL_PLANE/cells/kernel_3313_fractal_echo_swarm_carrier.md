...
- plane: `kernel`
- address: `3313`
- components: `fractal echo` -> `swarm carrier` -> `octave grammar` -> `renewal vector`
...
- output atom: `04_SWARM/output_atoms/atom_3313.md`

## 256^4 Expansion Vector

- kernel address: `3313`
- market address: `3133`
- execution address: `0020`
- governance address: `3133`
