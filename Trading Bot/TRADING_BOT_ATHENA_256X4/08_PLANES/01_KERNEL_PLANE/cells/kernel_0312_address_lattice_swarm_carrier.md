...
- plane: `kernel`
- address: `0312`
- components: `address lattice` -> `swarm carrier` -> `octave grammar` -> `execution vector`
...
- output atom: `04_SWARM/output_atoms/atom_0312.md`

## 256^4 Expansion Vector

- kernel address: `0312`
- market address: `3120`
- execution address: `3021`
- governance address: `2130`
