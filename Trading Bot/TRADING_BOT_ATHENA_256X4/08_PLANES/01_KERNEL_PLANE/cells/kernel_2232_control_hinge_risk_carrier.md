...
- plane: `kernel`
- address: `2232`
- components: `control hinge` -> `risk carrier` -> `proof grammar` -> `execution vector`
...
- output atom: `04_SWARM/output_atoms/atom_2232.md`

## 256^4 Expansion Vector

- kernel address: `2232`
- market address: `2322`
- execution address: `1101`
- governance address: `2322`
