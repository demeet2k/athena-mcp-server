# Governance Plane 0320

## Address Signature

- plane: `governance`
- address: `0320`
- components: `evidence table` -> `conflict ledger` -> `rollback path` -> `container pack`
...
- output atom: `04_SWARM/output_atoms/atom_0320.md`
