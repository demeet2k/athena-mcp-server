# Governance Plane 0022

## Address Signature

- plane: `governance`
- address: `0022`
- components: `evidence table` -> `pin ledger` -> `rollback path` -> `observer pack`
...
- output atom: `04_SWARM/output_atoms/atom_0022.md`

## 256^4 Expansion Vector

- kernel address: `0220`
- market address: `0220`
- execution address: `3311`
- governance address: `0022`
