# Governance Plane 0211

## Address Signature

- plane: `governance`
- address: `0211`
- components: `evidence table` -> `ambiguity ledger` -> `promotion path` -> `import pack`
...
- output atom: `04_SWARM/output_atoms/atom_0211.md`

## 256^4 Expansion Vector

- kernel address: `2110`
- market address: `2110`
- execution address: `3122`
