# Governance Plane 1132

## Address Signature

- plane: `governance`
- address: `1132`
- components: `replay capsule` -> `residual ledger` -> `publication path` -> `observer pack`
...
- output atom: `04_SWARM/output_atoms/atom_1132.md`
