# Governance Plane 0203

## Address Signature

- plane: `governance`
- address: `0203`
- components: `evidence table` -> `ambiguity ledger` -> `verification path` -> `conductor pack`
...
- output atom: `04_SWARM/output_atoms/atom_0203.md`

## 256^4 Expansion Vector

- kernel address: `2030`
- market address: `2030`
- execution address: `3130`
- governance address: `0203`
