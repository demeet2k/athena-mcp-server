# Governance Plane 0103

## Address Signature

- plane: `governance`
- address: `0103`
- components: `evidence table` -> `residual ledger` -> `verification path` -> `conductor pack`
...
- output atom: `04_SWARM/output_atoms/atom_0103.md`

## 256^4 Expansion Vector

- kernel address: `1030`
- market address: `1030`
- execution address: `3230`
- governance address: `0103`
