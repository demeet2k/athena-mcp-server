# Governance Plane 3120

## Address Signature

- plane: `governance`
- address: `3120`
- components: `deployment corridor` -> `residual ledger` -> `rollback path` -> `container pack`
...
- output atom: `04_SWARM/output_atoms/atom_3120.md`

## 256^4 Expansion Vector

- kernel address: `1203`
- market address: `1203`
- execution address: `0213`
- governance address: `3120`
