# Governance Plane 0300

## Address Signature

- plane: `governance`
- address: `0300`
- components: `evidence table` -> `conflict ledger` -> `verification path` -> `container pack`
...
- task cell: `04_SWARM/task_cells/task_030.md`
- output atom: `04_SWARM/output_atoms/atom_0300.md`

## 256^4 Expansion Vector

- kernel address: `3000`
- market address: `3000`
- execution address: `3033`
- governance address: `0300`
