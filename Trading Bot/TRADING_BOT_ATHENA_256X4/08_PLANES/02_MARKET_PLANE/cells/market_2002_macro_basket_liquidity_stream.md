...
- plane: `market`
- address: `2002`
- components: `macro basket` -> `liquidity stream` -> `leader set` -> `execution window`
...
- output atom: `04_SWARM/output_atoms/atom_2002.md`

## 256^4 Expansion Vector

- kernel address: `0022`
- market address: `2002`
- execution address: `1331`
- governance address: `2002`
