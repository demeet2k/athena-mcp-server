...
- plane: `market`
- address: `0200`
- components: `crypto basket` -> `volatility stream` -> `leader set` -> `thesis window`
...
- output atom: `04_SWARM/output_atoms/atom_0200.md`

## 256^4 Expansion Vector

- kernel address: `2000`
- market address: `0200`
- execution address: `3133`
- governance address: `0020`
