...
- plane: `market`
- address: `3203`
- components: `cross-market basket` -> `volatility stream` -> `leader set` -> `review window`
...
- output atom: `04_SWARM/output_atoms/atom_3203.md`

## 256^4 Expansion Vector

- kernel address: `2033`
- market address: `3203`
- execution address: `0130`
- governance address: `3023`
