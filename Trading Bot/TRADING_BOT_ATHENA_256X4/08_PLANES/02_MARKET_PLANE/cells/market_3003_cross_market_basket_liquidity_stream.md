...
- plane: `market`
- address: `3003`
- components: `cross-market basket` -> `liquidity stream` -> `leader set` -> `review window`
...
- task cell: `04_SWARM/task_cells/task_300.md`
- output atom: `04_SWARM/output_atoms/atom_3003.md`
