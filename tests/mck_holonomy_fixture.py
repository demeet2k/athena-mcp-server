...
FIXTURE_STANDING="SOURCE_PACKET_PROJECTION_FOR_EXECUTION; NOT_INDEPENDENT_SOURCE_COPY"


def L(layer_id,role,decoder,tags,loss=None,authority="PUBLIC_TEXTUAL_MODEL"):
    return {"layer_id":layer_id,"semantic_role":role,"decoder_role":decoder,"ontology_tags":list(tags),"authority_scope":authority,"standing":"SECONDARY_SCHOLARSHIP","provenance":[],"source_language_or_text_layer":layer_id,"invariants":[],"declared_loss":list(loss or [])}
...
FAMILIES=[
 {"family_id":"H01.YIJING","name":"Yijing composite textual/commentarial strata","source_refs":[H01],"held_out_from":["REGRESSION12","STRATA10_PRIMARY_DESIGN_SET"],"layers":[
  L("H01.S0.GRAPHIC_SYMBOLS","graphic divinatory/change symbols","symbolic pattern/address layer",["trigrams","hexagrams","change","graphic_symbols"]),
  L("H01.S1.HEXAGRAM_LINE_STATEMENTS","written hexagram and line statements attached to graphic symbols","textual statement layer used to interpret hexagram/line configurations",["hexagrams","line_statements","historical_events","divination_reports"],["graphic-only role is expanded by attached textual statements"]),
  L("H01.S2.TEN_WINGS","later commentarial-philosophical writings interpreting symbols and statements","philosophical/cosmological commentary layer",["hexagrams","Ten_Wings","cosmic_patterns","human_nature_relations","philosophy"],["later philosophical/cosmological interpretive roles are not identical to earlier graphic or statement roles"]),
  L("H01.S3.ZHU_XI_COMMENTARY","later commentary distinguishing classic hexagram materials from commentarial materials","meta-commentarial classification/interpretation layer",["classic_jing","commentary_zhuan","hexagrams","Ten_Wings","moral_cosmological_interpretation"],["later classification is a retrospective organization of earlier layers"])]},
 {"family_id":"H02.KABBALAH","name":"Premodern to modern Kabbalah: breaks and continuities","source_refs":[H02],"held_out_from":["REGRESSION12","STRATA10_PRIMARY_DESIGN_SET"],"layers":[
  L("H02.S0.PREMODERN","premodern kabbalistic textual/theosophical traditions","premodern exegesis/theosophy/theurgy within historical source traditions",["exegesis","sacral_texts","sefirotic_theosophy","theurgy","medieval_Kabbalah"],authority="HISTORICAL_TRADITION_SCOPE"),
  L("H02.S1.EARLY_MODERN_SAFEDIAN","early-modern/Safedian transformation and canon-forming developments","early-modern reinterpretive and canonical development layer",["Safed","early_modern","canonization","Lurianic_corpus","exegesis","theosophy"],["period-specific schools, crises and canonization alter context and emphasis"],"HISTORICAL_TRADITION_SCOPE"),
  L("H02.S2.MODERN","modern Kabbalah as historically autonomous yet continuous with premodern traditions","modern textual, experiential, organizational and exoteric interpretive contexts",["modern_Kabbalah","exegesis","theosophy","fraternal_groups","vernacularization","technology","globalization"],["modernity introduces autonomous forms shaped by technology, geopolitical/ideological change, vernacularization and new social organization"],"MODERN_HISTORICAL_TRADITION_SCOPE")]},
 {"family_id":"H03.IBN_EZRA_TRANSMISSION","name":"Arabic to Hebrew to Latin astronomy/astrology transmission through Abraham ibn Ezra","source_refs":[H03],"held_out_from":["REGRESSION12","STRATA10_PRIMARY_DESIGN_SET"],"layers":[
  ...
  L("H03.S1.HEBREW_IBN_EZRA","Ibn Ezra's Hebrew astronomical/astrological works and translations/adaptations","Hebrew-language technical scholarly transmission layer",["Hebrew_scientific_writing","astronomy","astrology","Ibn_Ezra","technical_methods"],["selection, translation and reformulation occur in the Hebrew transmission layer"],"HISTORICAL_SCHOLARLY_SOURCE_SCOPE"),
  L("H03.S2.LATIN_RECEPTION","Latin translation and medieval Jewish/Christian reception of Ibn Ezra's works","Latin-language translation/reception layer in medieval Western scholarly contexts",["Latin_translation","astronomy","astrology","medieval_reception","Ibn_Ezra"],["language, audience and reception context change across Hebrew-to-Latin transmission"],"HISTORICAL_SCHOLARLY_SOURCE_SCOPE")]}
]
for fam in FAMILIES:
...
PACKET={"artifact":"ATHENA.MYTHIC.HOLONOMY.HELDOUT.V0","version":"MCK.HOLONOMY.BENCH.V0","families":FAMILIES,"cases":CASES,"distance_semantics":{"vector":["role_delta","decoder_delta","ontology_delta","authority_delta","standing_delta","provenance_delta","invariant_violations","unaccounted_loss"],"scalarization":"DISABLED_V0","standing_ranks":{"UNKNOWN":0,"MODERN_RECONSTRUCTION":1,"TRADITION_INTERNAL":1,"SECONDARY_SCHOLARSHIP":2,"LIVING_TRADITION_SOURCE":2,"PRIMARY_EVIDENCE":3}},"firewalls":["HELD_OUT_SOURCE_CASE != PRACTITIONER_VALIDATION","SEMANTIC_DRIFT != ERROR_BY_DEFAULT","CONTINUITY != IDENTITY","TRANSLATION != LOSSLESS_EQUIVALENCE","H_gamma != METAPHYSICAL_QUANTITY","SELF_GENERATED_SCORE != INDEPENDENT_WITNESS","BENCHMARK_GAIN != MCK_V2_PROMOTION"]}
