...
class MessageBoardTests(unittest.TestCase):
    ...
    def test_message_ack_and_release_preserve_communication_history(self):
        ...
        released = boards[1].release(agent_id="b", release_status="DONE", outcome="build complete")
    ...
    def test_heartbeat_renews_active_lease(self):
        ...
        heartbeat = boards[0].heartbeat(agent_id="a", lease_seconds=3600, note="still working")
