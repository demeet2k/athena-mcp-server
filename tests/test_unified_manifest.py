...
class UnifiedManifestTests(unittest.TestCase):
    ...
    def test_live_manifest_reports_v12_single_server_layers_and_compatibility(self):
    ...
    def test_maxdev_law_contains_v12_boundaries(self):
    ...
    def test_manifest_resources_and_surface2_include_v12(self):
        ...
        for group in ('manifest','collective_v4_v5_v6','collective_v7','collective_v8','collective_v9','collective_v10','collective_v11','collective_v12'):self.assertEqual(audit['groups'][group]['status'],'PASS')
