...
class UnifiedManifestTests(unittest.TestCase):
    ...
    def test_live_manifest_reports_v11_promotion2_and_compatibility(self):
        ...
        self.assertIn('ATTESTED_READY',manifest['promotion']);self.assertIn('host-internal trusted verifier',manifest['promotion'])
    ...
    def test_manifest_resources_surface_and_promotion_resource_are_current(self):
        ...
        for uri in ['athena://manifest','athena://runtime/unified-manifest','athena://runtime/maxdev','athena://collective/v5','athena://collective/v6','athena://collective/v7','athena://collective/v8','athena://collective/v9','athena://collective/v10','athena://collective/v11','athena://promotion']:
        ...
        self.assertEqual(promotion['version'],'ATHENA.PROMOTION.2');self.assertIn('ATHENA.PROMOTION.1',promotion['compat']);self.assertIn('ATTESTED_READY',promotion['law'])
        audit=self.tool('athena_surface_audit',{'run_probes':True})
        for group in ('manifest','promotion','collective_v4_v5_v6','collective_v7','collective_v8','collective_v9','collective_v10','collective_v11'):self.assertEqual(audit['groups'][group]['status'],'PASS')
