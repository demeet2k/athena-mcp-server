...
class MetadataConsistencyTests(unittest.TestCase):
    ...
    def test_v6_is_exposed_by_mcp(self):
        with tempfile.NamedTemporaryFile(suffix='.db') as f:
            ...
            for uri in ('athena://collective/v4','athena://collective/v5','athena://collective/v6'):
                self.assertIn(uri,uris)
            for i,uri in enumerate(('athena://collective/v5','athena://collective/v6'),start=4):
