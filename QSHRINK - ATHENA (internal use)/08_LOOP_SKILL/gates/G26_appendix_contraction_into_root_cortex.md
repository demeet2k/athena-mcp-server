# G26 - Appendix contraction into root cortex
...
make appendix hubs active cortical infrastructure rather than loose references

## Panic-loop consequence

When this gate is active, the pass priority is: expand with new witness before trusting.
