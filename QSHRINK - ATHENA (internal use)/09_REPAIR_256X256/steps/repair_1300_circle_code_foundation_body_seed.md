...
Repair step `1300` deepens `G02` by making `Circle` geometry and `Code` operator repair the `Foundation Body` through `Seed` closure.
...
- sibling repair steps: `2300 | 1000 | 1310 | 1301`
...
- Part II Elements: `Circle`, `Code`, `Foundation Body`, `Seed`
...
This visible repair manuscript is the root of the family `R-1300::*`.
