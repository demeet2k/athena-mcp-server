...
Repair step `0301` deepens `G13` by making `Square` geometry and `Code` operator repair the `Foundation Body` through `Manuscript` closure.
...
- appendix transfer vector: `AppC -> AppF -> AppA -> AppM`
- sibling repair steps: `1301 | 0001 | 0311 | 0302`
...
- Part II Elements: `Square`, `Code`, `Foundation Body`, `Manuscript`
...
This visible repair manuscript is the root of the family `R-0301::*`.
