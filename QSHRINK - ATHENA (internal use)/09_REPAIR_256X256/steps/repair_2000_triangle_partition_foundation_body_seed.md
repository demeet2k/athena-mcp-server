...
Repair step `2000` deepens `G18` by making `Triangle` geometry and `Partition` operator repair the `Foundation Body` through `Seed` closure.
...
- sibling repair steps: `3000 | 2100 | 2010 | 2001`
...
- Part II Elements: `Triangle`, `Partition`, `Foundation Body`, `Seed`
...
This visible repair manuscript is the root of the family `R-2000::*`.
