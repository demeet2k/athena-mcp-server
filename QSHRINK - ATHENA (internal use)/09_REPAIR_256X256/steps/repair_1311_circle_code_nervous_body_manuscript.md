...
Repair step `1311` deepens `G07` by making `Circle` geometry and `Code` operator repair the `Nervous Body` through `Manuscript` closure.
...
- sibling repair steps: `2311 | 1011 | 1321 | 1312`
...
- Part II Elements: `Circle`, `Code`, `Nervous Body`, `Manuscript`
...
This visible repair manuscript is the root of the family `R-1311::*`.
