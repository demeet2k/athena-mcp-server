...
def main() -> int:
    ...
    add_common_response_flags(record_parser)

    search_parser = subparsers.add_parser("search")
    add_search_filters(search_parser)
    add_common_response_flags(search_parser)
    ...
    facet_parser.add_argument("--lens")
    facet_parser.add_argument("--field")
    facet_parser.add_argument("--zpoint")
    facet_parser.add_argument("--space")
    facet_parser.add_argument("--hemisphere")
    facet_parser.add_argument("--route-role", dest="route_role")
    add_common_response_flags(facet_parser)
    ...
    if args.mode == "record":
        ...
        selected = [
            ...
            (SEARCH_FILTER_TO_FACET["lens"], args.lens),
            (SEARCH_FILTER_TO_FACET["field"], args.field),
            (SEARCH_FILTER_TO_FACET["zpoint"], args.zpoint),
            (SEARCH_FILTER_TO_FACET["space"], args.space),
            (SEARCH_FILTER_TO_FACET["hemisphere"], args.hemisphere),
            (SEARCH_FILTER_TO_FACET["route_role"], args.route_role),
        ]
