...
description: "Historical mirror skill. Use the live `14_DEEPER...` deep-root router for current whole-framework synthesis."
---
...
This skill belongs to an older deep-net Athena root.
It is preserved as a historical snapshot, not as the live whole-corpus authority.
