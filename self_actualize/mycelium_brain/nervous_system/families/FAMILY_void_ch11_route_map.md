...
- Family: `Void_CH11`
- Manuscript: `InformationFromTheVoid`
- Primary station: `Ch11`
- Primary face: `Aether`
- Primary rail: `Me`
- Primary hubs: `AppL`, `AppI`, `AppM`
- Preferred scale: `S8`
- Preferred regime: `restart-token`
- Typical truth path: `AMBIG -> NEAR -> OK`
...
- core evidence-promotion node
- carries the unresolved but highest-yield Chapter 11 route
...
`<Void_CH11, NERVOUS_SYSTEM_Ch11, Ch11, R, 4, a, EAFW, Arc3, Me, AppM, NEAR, classical>`

Role:

- replay and chapter-runtime bridge
- ties manuscript language back to cortex and restart continuity
