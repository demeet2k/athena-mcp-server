...
```mermaid
flowchart LR
  FAM["identity-and-instruction (20)"]
  HM["HC-MATH"]
  HY["HC-MYTH"]
  FAM --> HM
  FAM --> HY
  TSF-crosscorpusmycelial["CrossCorpusMycelial"]
  FAM --> TSF-crosscorpusmycelial
  TSF-emergentsupermap["EmergentSupermap"]
  FAM --> TSF-emergentsupermap
  TSF-grandcentral["GrandCentral"]
  FAM --> TSF-grandcentral
  TSF-l2deepemergence["L2DeepEmergence"]
  FAM --> TSF-l2deepemergence
```
