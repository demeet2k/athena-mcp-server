#!/usr/bin/env python3
"""Validate W32 next-octave authority/quorum bundles without side effects."""
...
from crystal_108d.next_octave_authority_quorum import (  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("w32-next-octave-authority-quorum-preflight.json"),
    )
    ...
    if arguments.check_snapshot:
        ...
        if mismatches:
            raise RuntimeError(f"W32 protected boundary mismatch: {mismatches}")
        print(
    ...
    envelope = {
        "schema": "athena.w32-next-octave-authority-quorum-preflight/v1",
        "verifier": {
    ...
    return (
        ...
        and result.get("production_registry_open") is False
